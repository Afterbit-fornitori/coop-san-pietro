...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 text-gray-900 dark:text-gray-100">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold">Modifica Cliente: {{ $client->business_name }}</h2>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="business_name" id="business_name" value="{{ old('business_name', $client->business_name) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="vat_number" id="vat_number" value="{{ old('vat_number', $client->vat_number) }}" maxlength="11"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="tax_code" id="tax_code" value="{{ old('tax_code', $client->tax_code) }}" maxlength="16"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500"
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="city" id="city" value="{{ old('city', $client->city) }}" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="postal_code" id="postal_code" value="{{ old('postal_code', $client->postal_code) }}" maxlength="10" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500"
                                placeholder="44022">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="province" id="province" value="{{ old('province', $client->province) }}" maxlength="2" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500"
                                placeholder="FE">
                        </div>
                    </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="pec" id="pec" value="{{ old('pec', $client->pec) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="sdi_code" id="sdi_code" value="{{ old('sdi_code', $client->sdi_code) }}" maxlength="7"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500"
                            placeholder="XXXXXXX">
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="note" id="note" rows="3"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500">{{ old('note', $client->note) }}</textarea>
                    </div>
