...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 text-gray-900 dark:text-gray-100">
        <div class="flex items-center mb-6">
            ...
            <h2 class="text-2xl font-semibold">Modifica Documento: {{ $document->title }}</h2>
        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" 
                                ...
                                <option value="ddt" {{ old('type', $document->type) == 'ddt' ? 'selected' : '' }}>DDT</option>
                                <option value="invoice" {{ old('type', $document->type) == 'invoice' ? 'selected' : '' }}>Fattura</option>
                                <option value="other" {{ old('type', $document->type) == 'other' ? 'selected' : '' }}>Altro</option>
                            </select>
                        </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-3 bg-blue-50 dark:bg-blue-900 rounded">
                            <p class="text-sm font-medium">File Attuale:</p>
                        ...
                        <div>
                            <label for="file" class="block text-sm font-medium">
                                Sostituisci File {{ $document->path ? '(Opzionale)' : '*' }}
                            </label>
