...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 text-gray-900 dark:text-gray-100">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold">Modifica Zona: {{ $zone->nome }}</h2>
        ...
        <form action="{{ route('production-zones.update', $zone) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="codice" id="codice" value="{{ old('codice', $zone->codice) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="nome" id="nome" value="{{ old('nome', $zone->nome) }}" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="mq" id="mq" value="{{ old('mq', $zone->mq) }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500">
                </div>
                ...
                <div>
                    ...
                    <select name="classe_sanitaria" id="classe_sanitaria"
                        ...
                        <option value="A" {{ old('classe_sanitaria', $zone->classe_sanitaria) === 'A' ? 'selected' : '' }}>Classe A</option>
                        <option value="B" {{ old('classe_sanitaria', $zone->classe_sanitaria) === 'B' ? 'selected' : '' }}>Classe B</option>
                        <option value="C" {{ old('classe_sanitaria', $zone->classe_sanitaria) === 'C' ? 'selected' : '' }}>Classe C</option>
                    </select>
                ...
                <div>
                    <div class="flex items-center mb-2">
                        <input type="checkbox" name="declassificazione_temporanea" id="declassificazione_temporanea" value="1"
                            {{ old('declassificazione_temporanea', $zone->declassificazione_temporanea) ? 'checked' : '' }}
                ...
                <div>
                    ...
                    <input type="date" name="data_declassificazione" id="data_declassificazione"
                        value="{{ old('data_declassificazione', $zone->data_declassificazione ? $zone->data_declassificazione->format('Y-m-d') : '') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500">
