        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex items-center mb-6">
                    ...
                    <h2 class="text-2xl font-semibold">Modifica Registro - Settimana {{ $weeklyRecord->week }}/{{ $weeklyRecord->year }}</h2>
                </div>
                ...
                <form action="{{ route('weekly-records.update', $weeklyRecord) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-yellow-50 p-6 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                            <div>
                                ...
                                <input type="number" step="0.01" name="taxable_amount" value="{{ old('taxable_amount', $weeklyRecord->taxable_amount) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Acconto Pagato €</label>
                                <input type="number" step="0.01" name="advance_paid" value="{{ old('advance_paid', $weeklyRecord->advance_paid) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Ritenuta d'Acconto €</label>
                                <input type="number" step="0.01" name="withholding_tax" value="{{ old('withholding_tax', $weeklyRecord->withholding_tax) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">PROFIS €</label>
                                <input type="number" step="0.01" name="profis" value="{{ old('profis', $weeklyRecord->profis) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Bonifico €</label>
                                <input type="number" step="0.01" name="bank_transfer" value="{{ old('bank_transfer', $weeklyRecord->bank_transfer) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        </div>
                    </div> -->
